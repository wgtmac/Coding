...
public class LargestDivisibleSubset {
    ...
    private static class Helper implements Comparable<Helper> {
        ...
        @Override
        public int compareTo(Helper that) {
    ...
    public List<Integer> largestDivisibleSubset(int[] nums) {
        ...
        for (int i = 0; i < nums.length; ++i) {
            ...
            if (prevHelper != null) {
                set.add(new Helper(i, prevHelper.cnt + 1));
                prev[i] = prevHelper.idx;
            } else {
                set.add(new Helper(i, 1));
                prev[i] = -1;
            }
        }
    ...
    public List<Integer> largestDivisibleSubset_TLE(int[] nums) {
        ...
        List<Integer> maxList = new ArrayList<>();
        helper(nums, 0, new ArrayList<>(), maxList);

        return maxList;
    }

    private void helper(int[] nums, int i, List<Integer> list, List<Integer> maxList) {
