...
public class RecordType extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RecordType\",\"namespace\":\"gwu.hadoop.avro.generated\",\"fields\":[{\"name\":\"year\",\"type\":\"int\"},{\"name\":\"temperature\",\"type\":\"int\"},{\"name\":\"stationId\",\"type\":\"string\"}]}");
   ...
   */
  public RecordType(java.lang.Integer year, java.lang.Integer temperature, java.lang.CharSequence stationId) {
    this.year = year;
  ...
  public static gwu.hadoop.avro.generated.RecordType.Builder newBuilder() {
    return new gwu.hadoop.avro.generated.RecordType.Builder();
  }
  
  /** Creates a new RecordType RecordBuilder by copying an existing Builder */
  public static gwu.hadoop.avro.generated.RecordType.Builder newBuilder(gwu.hadoop.avro.generated.RecordType.Builder other) {
    return new gwu.hadoop.avro.generated.RecordType.Builder(other);
  }
  
  /** Creates a new RecordType RecordBuilder by copying an existing RecordType instance */
  public static gwu.hadoop.avro.generated.RecordType.Builder newBuilder(gwu.hadoop.avro.generated.RecordType other) {
    return new gwu.hadoop.avro.generated.RecordType.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordType>
    ...
    private Builder() {
      super(gwu.hadoop.avro.generated.RecordType.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(gwu.hadoop.avro.generated.RecordType.Builder other) {
      super(other);
    ...
    private Builder(gwu.hadoop.avro.generated.RecordType other) {
            super(gwu.hadoop.avro.generated.RecordType.SCHEMA$);
      if (isValidValue(fields()[0], other.year)) {
        this.year = data().deepCopy(fields()[0].schema(), other.year);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'year' field */
    public gwu.hadoop.avro.generated.RecordType.Builder setYear(int value) {
    ...
    public gwu.hadoop.avro.generated.RecordType.Builder clearYear() {
    ...
    /** Sets the value of the 'temperature' field */
    public gwu.hadoop.avro.generated.RecordType.Builder setTemperature(int value) {
    ...
    public gwu.hadoop.avro.generated.RecordType.Builder clearTemperature() {
    ...
    /** Sets the value of the 'stationId' field */
    public gwu.hadoop.avro.generated.RecordType.Builder setStationId(java.lang.CharSequence value) {
    ...
    public gwu.hadoop.avro.generated.RecordType.Builder clearStationId() {
      stationId = null;
