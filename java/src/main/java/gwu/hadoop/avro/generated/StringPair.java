...
public class StringPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StringPair\",\"namespace\":\"gwu.hadoop.avro.generated\",\"doc\":\"A pair of strings.\",\"fields\":[{\"name\":\"left\",\"type\":\"string\"},{\"name\":\"right\",\"type\":\"string\"}]}");
  ...
  public static gwu.hadoop.avro.generated.StringPair.Builder newBuilder() {
    return new gwu.hadoop.avro.generated.StringPair.Builder();
  }
  
  /** Creates a new StringPair RecordBuilder by copying an existing Builder */
  public static gwu.hadoop.avro.generated.StringPair.Builder newBuilder(gwu.hadoop.avro.generated.StringPair.Builder other) {
    return new gwu.hadoop.avro.generated.StringPair.Builder(other);
  }
  
  /** Creates a new StringPair RecordBuilder by copying an existing StringPair instance */
  public static gwu.hadoop.avro.generated.StringPair.Builder newBuilder(gwu.hadoop.avro.generated.StringPair other) {
    return new gwu.hadoop.avro.generated.StringPair.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringPair>
    ...
    private Builder() {
      super(gwu.hadoop.avro.generated.StringPair.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(gwu.hadoop.avro.generated.StringPair.Builder other) {
      super(other);
    ...
    private Builder(gwu.hadoop.avro.generated.StringPair other) {
            super(gwu.hadoop.avro.generated.StringPair.SCHEMA$);
      if (isValidValue(fields()[0], other.left)) {
        this.left = data().deepCopy(fields()[0].schema(), other.left);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'left' field */
    public gwu.hadoop.avro.generated.StringPair.Builder setLeft(java.lang.CharSequence value) {
    ...
    public gwu.hadoop.avro.generated.StringPair.Builder clearLeft() {
      left = null;
    ...
    /** Sets the value of the 'right' field */
    public gwu.hadoop.avro.generated.StringPair.Builder setRight(java.lang.CharSequence value) {
    ...
    public gwu.hadoop.avro.generated.StringPair.Builder clearRight() {
      right = null;
